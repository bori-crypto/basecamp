...
// 🧹 찌꺼기 제거: import GearManagement from './RegionB/GearManagement';
...
const RegionB = ({ isAdmin, data }) => {
  ...
  // 🧹 찌꺼기 경고: RUNNING_WORKER_URL은 App.jsx 수정 시 WORKER_URL로 롤백해야 합니다.
  const { WORKER_URL, adminPassword } = useContext(AppContext); 
        ...
        {step === 0 ? (
          ...
          <div className="animate-in zoom-in-95 duration-300 h-full">
            {selectedCategory === 'photos' ? (
              ...
              <RunningLog
                isAdmin={isAdmin}
                workerUrl={WORKER_URL} // 🧹 찌꺼기 제거: RUNNING_WORKER_URL -> WORKER_URL로 롤백
                adminPassword={adminPassword}
              />
            // 🧹 찌꺼기 제거: 장비 관리 분기 로직(GearManagement 렌더링) 전체 삭제
            ) : (
