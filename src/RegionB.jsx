...
const RegionB = ({ isAdmin }) => {
  ...
  const menuData = {
    ...
    swimming: { label: "수    영", icon: <Waves size={24} />, color: "from-sky-400 to-blue-600", sub: [{ label: "기록 측정", data: [] }] },
    fitness: { label: "강철 체력", icon: <Dumbbell size={24} />, color: "from-slate-500 to-gray-700", sub: [{ label: "루틴", data: [] }] }
  };
